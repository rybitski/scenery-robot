...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.disableManualControl = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.disableManualControl.setFont(font)
        self.disableManualControl.setObjectName(_fromUtf8("disableManualControl"))
        self.gridLayout_2.addWidget(self.disableManualControl, 1, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.disableManualControl.setText(_translate("MainWindow", "Disable Manual", None))
