...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.ipSpecify, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.portSpecify, 3, 4, 1, 1)
        self.controllerDisconnect = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.controllerDisconnect.setFont(font)
        self.controllerDisconnect.setObjectName(_fromUtf8("controllerDisconnect"))
        self.gridLayout_2.addWidget(self.controllerDisconnect, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.recordPath, 3, 3, 1, 1)
        self.loadQueueSet = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.loadQueueSet.setFont(font)
        self.loadQueueSet.setObjectName(_fromUtf8("loadQueueSet"))
        self.gridLayout_2.addWidget(self.loadQueueSet, 3, 1, 1, 1)
        self.queueGo = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.queueGo.setFont(font)
        self.queueGo.setObjectName(_fromUtf8("queueGo"))
        self.gridLayout_2.addWidget(self.queueGo, 0, 0, 1, 1)
        self.queueStop = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.queueStop.setFont(font)
        self.queueStop.setObjectName(_fromUtf8("queueStop"))
        self.gridLayout_2.addWidget(self.queueStop, 1, 0, 1, 1)
        self.queueSetSave = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.queueSetSave.setFont(font)
        self.queueSetSave.setObjectName(_fromUtf8("queueSetSave"))
        self.gridLayout_2.addWidget(self.queueSetSave, 0, 1, 1, 1)
        self.newQueueSetSave = QtGui.QPushButton(self.map)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.newQueueSetSave.setFont(font)
        self.newQueueSetSave.setObjectName(_fromUtf8("newQueueSetSave"))
        self.gridLayout_2.addWidget(self.newQueueSetSave, 1, 1, 1, 1)
        ...
        self.robot_control_mode = QtGui.QLabel(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.robot_control_mode.sizePolicy().hasHeightForWidth())
        self.robot_control_mode.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.robot_control_mode.setFont(font)
        self.robot_control_mode.setFrameShape(QtGui.QFrame.StyledPanel)
        self.robot_control_mode.setObjectName(_fromUtf8("robot_control_mode"))
        self.gridLayout_6.addWidget(self.robot_control_mode, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.controllerDisconnect.setText(_translate("MainWindow", "Disconnect Controller", None))
        ...
        self.loadQueueSet.setText(_translate("MainWindow", "Load Queue Set", None))
        self.queueGo.setText(_translate("MainWindow", "Go", None))
        self.queueStop.setText(_translate("MainWindow", "Stop", None))
        self.queueSetSave.setText(_translate("MainWindow", "Save Queue Set", None))
        self.newQueueSetSave.setText(_translate("MainWindow", "Save New Queue Set", None))
        ...
        self.robot_control_mode.setText(_translate("MainWindow", "Robot Control: Disconnected", None))
